...
import logo8 from "./Images/download-2.png"
    ...
    return (
        <div className="flex flex-wrap">
            <div className="w-full md:w-1/2  item-center lg:py-40">
                <div className="mt-5">
                    <h2 className="px-5 font-bold text-5xl">JBit ICO starts in... </h2>
                </div>
            ...
            <div className=" w-full px-10 text-white py-4 py-4" style={{
            ...
            <div className=" w-full px-10 py-4 text-black" style={{
                ...
                <p className="px-10 items-center" > JBIT Mobile Wallet enables Two Factor Authentication, also known as 2FA, two step verification along with a 4 digit security pin. JBIT also provides the users to exchange our coins using fiat currencies or cryptocurrencies. You can download our wallet app from Playstore or iTunes which provides
            ...
            <div className="flex w-full  py-3  flex-wrap justify-between">
...
business plan, features and benefits for its users.</p>
            ...
            <div className="lg:flex w-full px-5 text-white py-4 justify-between" style={{
                backgroundImage: `url(${logo2})`
            }}>
                <div className="w-full md:w-1/5">
                    <img src={logo8} alt="jooby" />
                </div>
                <div className="w-full md:w-1/3">
                    <h3 className="text-white">Address</h3>
                    <p className="text-white">#14-02, The Arcade, 11 Collyer Quay  Singapore, 049317
                    Email: info@jbit.com
Local Telephone: +6562406981</p>
                ...
                <div className="  w-full md:w-1/3">
                    <div className="lg:flex">
                        <div className="w-full md:w-1/3 ">
                            <input class="shadow appearance-none text-sm bg-black border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Enter your name" />
                        </div>
                        <div className="w-full md:w-1/3 lg:px-3 ">
                            <input class="shadow appearance-none text-sm bg-black border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Enter your EmailID" />

                        </div>
                        <div className="w-full md:w-1/3">
                            <input class="shadow appearance-none text-sm bg-black border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Enter your Phone Number" />

                        </div>
                    </div>
                    <div className="w-full py-3 ml-1">
                        <textarea class="w-full resize border bg-black rounded focus:outline-none focus:shadow-outline px-2" placeholder="Enter your Description"></textarea>
                    </div>
